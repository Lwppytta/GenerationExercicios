...
public class Controle extends Ingressos implements Calculos, Opcoes {
	...
	public void DescricaoFilme() {
		System.out.println("\n1 - O Castelo Animado / 2 - A Viagem de Chihiro / 3 - Vidas ao Vento/ 4 - Ponyo");
	}
	...
	public void DescricaoHorario1(int controCartaz) {
		...
		if (controCartaz == 1) {
			...
			System.out.println("(1) O Castelo Animado | (2) A Viagem de Chihiro | (3) Vidas ao Vento | (4) Ponyo | (5) Ver todos | (0) Voltar ao menu"+Cores.TEXT_RESET);
	...
	public void DescricaoPreco() {
		System.out.println("Preço base R$50,00 | 3D R$60,00 | Meia R$25,00 | Meia-3D R$30,00");
